...
```bash
pip install git+https://github.com/bodencrouch/qtpy-theme-manager.git
...
Or grab a wheel from [Releases](https://github.com/bodencrouch/qtpy-theme-manager/releases).
